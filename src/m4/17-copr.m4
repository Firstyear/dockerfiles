...
ifdef(`WITHDNF', `RUN' dnf copr enable fabiand/rust-binary -y, `RUN' /usr/bin/wget -O /etc/yum.repos.d/_copr_fabiand-rust-binary.repo https://copr.fedorainfracloud.org/coprs/fabiand/rust-binary/repo/epel-7/fabiand-rust-binary-epel-7.repo)
